...
def register_types_ns3_aodv(module):
    ...
    module.add_container('std::map< ns3::Ipv4Address, uint32_t >', ('ns3::Ipv4Address', 'uint32_t'), container_type=u'map')
...
def register_Ns3AodvRerrHeader_methods(root_module, cls):
    ...
    cls.add_method('Print', 
                   ...
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodv-packet.h (module 'aodv'): bool ns3::aodv::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address, uint32_t> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, uint32_t > &', 'un')])
...
def register_Ns3AodvRoutingTable_methods(root_module, cls):
    ...
    cls.add_method('GetBadLinkLifetime', 
                   ...
                   [], 
                   is_const=True)
    ## aodv-rtable.h (module 'aodv'): void ns3::aodv::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, uint32_t, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, uint32_t> > > & unreachable) [member function]
    cls.add_method('GetListOfDestinationWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('std::map< ns3::Ipv4Address, uint32_t > &', 'unreachable')])
    ## aodv-rtable.h (module 'aodv'): void ns3::aodv::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, uint32_t, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, uint32_t> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, uint32_t > const &', 'unreachable')])
