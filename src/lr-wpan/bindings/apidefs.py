...
def register_types(module):
    ...
    ## sequence-number.h (module 'network'): ns3::SequenceNumber<uint8_t, signed char> [class]
    ...
    typehandlers.add_type_alias(u'ns3::Callback< void, uint32_t, ns3::Ptr< ns3::Packet >, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', u'ns3::PdDataIndicationCallback')
    typehandlers.add_type_alias(u'ns3::Callback< void, uint32_t, ns3::Ptr< ns3::Packet >, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', u'ns3::PdDataIndicationCallback*')
    typehandlers.add_type_alias(u'ns3::Callback< void, uint32_t, ns3::Ptr< ns3::Packet >, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', u'ns3::PdDataIndicationCallback&')
    ...
    typehandlers.add_type_alias(u'ns3::Callback< void, ns3::LrWpanPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', u'ns3::PlmeCcaConfirmCallback*')
    typehandlers.add_type_alias(u'ns3::Callback< void, ns3::LrWpanPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', u'ns3::PlmeCcaConfirmCallback&')
    typehandlers.add_type_alias(u'ns3::Callback< void, ns3::LrWpanPhyEnumeration, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', u'ns3::PlmeEdConfirmCallback')
    typehandlers.add_type_alias(u'ns3::Callback< void, ns3::LrWpanPhyEnumeration, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', u'ns3::PlmeEdConfirmCallback*')
    typehandlers.add_type_alias(u'ns3::Callback< void, ns3::LrWpanPhyEnumeration, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', u'ns3::PlmeEdConfirmCallback&')
...
def register_Ns3SequenceNumber8_methods(root_module, cls):
    cls.add_binary_comparison_operator('!=')
    cls.add_binary_numeric_operator('+', root_module['ns3::SequenceNumber8'], root_module['ns3::SequenceNumber8'], param('ns3::SequenceNumber< uint8_t, signed char > const &', u'right'))
    ...
    cls.add_binary_comparison_operator('>')
    cls.add_binary_comparison_operator('>=')
    ## sequence-number.h (module 'network'): ns3::SequenceNumber<uint8_t, signed char>::SequenceNumber() [constructor]
    cls.add_constructor([])
    ## sequence-number.h (module 'network'): ns3::SequenceNumber<uint8_t, signed char>::SequenceNumber(uint8_t value) [constructor]
    cls.add_constructor([param('uint8_t', 'value')])
    ## sequence-number.h (module 'network'): ns3::SequenceNumber<uint8_t, signed char>::SequenceNumber(ns3::SequenceNumber<uint8_t, signed char> const & value) [constructor]
    cls.add_constructor([param('ns3::SequenceNumber< uint8_t, signed char > const &', 'value')])
    ## sequence-number.h (module 'network'): uint8_t ns3::SequenceNumber<uint8_t, signed char>::GetValue() const [member function]
...
def register_Ns3LrWpanPhy_methods(root_module, cls):
    ...
    cls.add_method('SetPdDataIndicationCallback', 
                   'void', 
                   [param('ns3::Callback< void, uint32_t, ns3::Ptr< ns3::Packet >, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ...
    cls.add_method('SetPlmeEdConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::LrWpanPhyEnumeration, uint8_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
