...
def register_types(module):
    ...
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv4 >, uint32_t > > const_iterator', u'ns3::Ipv4InterfaceContainer::Iterator')
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv4 >, uint32_t > > const_iterator*', u'ns3::Ipv4InterfaceContainer::Iterator*')
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv4 >, uint32_t > > const_iterator&', u'ns3::Ipv4InterfaceContainer::Iterator&')
    ...
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv6 >, uint32_t > > const_iterator', u'ns3::Ipv6InterfaceContainer::Iterator')
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv6 >, uint32_t > > const_iterator*', u'ns3::Ipv6InterfaceContainer::Iterator*')
    typehandlers.add_type_alias(u'std::vector< std::pair< ns3::Ptr< ns3::Ipv6 >, uint32_t > > const_iterator&', u'ns3::Ipv6InterfaceContainer::Iterator&')
...
def register_Ns3Ipv4InterfaceContainer_methods(root_module, cls):
    ...
    ## ipv4-interface-container.h (module 'internet'): void ns3::Ipv4InterfaceContainer::Add(std::pair<ns3::Ptr<ns3::Ipv4>, uint32_t> ipInterfacePair) [member function]
    cls.add_method('Add', 
                   'void', 
                   [param('std::pair< ns3::Ptr< ns3::Ipv4 >, uint32_t >', 'ipInterfacePair')])
    ...
    cls.add_method('End', 
                   ...
                   [], 
                   is_const=True)
    ## ipv4-interface-container.h (module 'internet'): std::pair<ns3::Ptr<ns3::Ipv4>, uint32_t> ns3::Ipv4InterfaceContainer::Get(uint32_t i) const [member function]
    cls.add_method('Get', 
                   'std::pair< ns3::Ptr< ns3::Ipv4 >, uint32_t >', 
                   [param('uint32_t', 'i')], 
                   is_const=True)
