...
def register_types(module):
    ...
    typehandlers.add_type_alias(u'std::vector< uint8_t > const_iterator', u'ns3::ProtocolTlvValue::Iterator')
    typehandlers.add_type_alias(u'std::vector< uint8_t > const_iterator*', u'ns3::ProtocolTlvValue::Iterator*')
    typehandlers.add_type_alias(u'std::vector< uint8_t > const_iterator&', u'ns3::ProtocolTlvValue::Iterator&')
...
def register_Ns3WimaxPhy_methods(root_module, cls):
    ...
    ## wimax-phy.h (module 'wimax'): void ns3::WimaxPhy::StartScanning(uint64_t frequency, ns3::Time timeout, ns3::Callback<void, bool, uint64_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('StartScanning', 
                   'void', 
                   [param('uint64_t', 'frequency'), param('ns3::Time', 'timeout'), param('ns3::Callback< void, bool, uint64_t, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')])
...
def register_Ns3BSScheduler_methods(root_module, cls):
    ...
    cls.add_method('CheckForFragmentation', 
                   'bool', 
                   [param('ns3::Ptr< ns3::WimaxConnection >', 'connection'), param('int32_t', 'availableSymbols'), param('ns3::WimaxPhy::ModulationType', 'modulationType')])
