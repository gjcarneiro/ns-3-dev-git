...
def register_Ns3GeographicPositions_methods(root_module, cls):
    ...
    cls.add_method('RandCartesianPointsAroundGeographicPoint', 
                   ...
                   [param('double', 'originLatitude'), param('double', 'originLongitude'), param('double', 'maxAltitude'), param('int32_t', 'numPoints'), param('double', 'maxDistFromOrigin'), param('ns3::Ptr< ns3::UniformRandomVariable >', 'uniRand')], 
                   is_static=True)
    return
