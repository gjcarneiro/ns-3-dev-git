...
def register_types(module):
    ...
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::SpectrumConverter > > >', u'ns3::SpectrumConverterMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::SpectrumConverter > > >*', u'ns3::SpectrumConverterMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::SpectrumConverter > > >&', u'ns3::SpectrumConverterMap_t&')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::TxSpectrumModelInfo > > >', u'ns3::TxSpectrumModelInfoMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::TxSpectrumModelInfo > > >*', u'ns3::TxSpectrumModelInfoMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::TxSpectrumModelInfo > > >&', u'ns3::TxSpectrumModelInfoMap_t&')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::RxSpectrumModelInfo > > >', u'ns3::RxSpectrumModelInfoMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::RxSpectrumModelInfo > > >*', u'ns3::RxSpectrumModelInfoMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo, std::less< uint32_t >, std::allocator< std::pair< uint32_t const, ns3::RxSpectrumModelInfo > > >&', u'ns3::RxSpectrumModelInfoMap_t&')
