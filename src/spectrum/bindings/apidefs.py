...
def register_types(module):
    ...
    typehandlers.add_type_alias(u'std::pair< uint32_t, uint32_t >', u'ns3::WifiSpectrumValueHelper::StartStop')
    typehandlers.add_type_alias(u'std::pair< uint32_t, uint32_t >*', u'ns3::WifiSpectrumValueHelper::StartStop*')
    typehandlers.add_type_alias(u'std::pair< uint32_t, uint32_t >&', u'ns3::WifiSpectrumValueHelper::StartStop&')
    ...
    module.add_container('ns3::SpectrumConverterMap_t', ('uint32_t', 'ns3::SpectrumConverter'), container_type=u'map')
    module.add_container('std::vector< std::pair< uint32_t, uint32_t > >', 'std::pair< uint32_t, uint32_t >', container_type=u'vector')
    ...
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter >', u'ns3::SpectrumConverterMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter >*', u'ns3::SpectrumConverterMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::SpectrumConverter >&', u'ns3::SpectrumConverterMap_t&')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo >', u'ns3::TxSpectrumModelInfoMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo >*', u'ns3::TxSpectrumModelInfoMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::TxSpectrumModelInfo >&', u'ns3::TxSpectrumModelInfoMap_t&')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo >', u'ns3::RxSpectrumModelInfoMap_t')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo >*', u'ns3::RxSpectrumModelInfoMap_t*')
    typehandlers.add_type_alias(u'std::map< uint32_t, ns3::RxSpectrumModelInfo >&', u'ns3::RxSpectrumModelInfoMap_t&')
...
def register_Ns3WifiSpectrumValueHelper_methods(root_module, cls):
    ...
    cls.add_method('CreateRfFilter', 
                   ...
                   is_static=True)
    ## wifi-spectrum-value-helper.h (module 'spectrum'): static void ns3::WifiSpectrumValueHelper::CreateSpectrumMaskForOfdm(ns3::Ptr<ns3::SpectrumValue> c, std::vector<std::pair<uint32_t, uint32_t>, std::allocator<std::pair<uint32_t, uint32_t> > > allocatedSubBands, ns3::WifiSpectrumValueHelper::StartStop maskBand, double txPowerPerBandW, uint32_t nGuardBands, uint32_t innerSlopeWidth, double lowestPointDbr) [member function]
    cls.add_method('CreateSpectrumMaskForOfdm', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumValue >', 'c'), param('std::vector< std::pair< uint32_t, uint32_t > >', 'allocatedSubBands'), param('std::pair< uint32_t, uint32_t >', 'maskBand'), param('double', 'txPowerPerBandW'), param('uint32_t', 'nGuardBands'), param('uint32_t', 'innerSlopeWidth'), param('double', 'lowestPointDbr')], 
                   is_static=True)
